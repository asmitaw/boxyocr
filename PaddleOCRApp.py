...
def paddle_ocr(image,file_name):
   ...
   # im_show.save( "results/" + file_name)
...
with col1:
    ...
    # Now do something with the image! For example, let's display it:
       ...
       #  if model_P:
            #do something with paddle OCR
        #IMAGE_ROOT = "./train_data/rec/train"
        IMAGE_ROOT = "/home/amol/boxylink/train_data/rec/train"
        ...
        for filename in os.listdir(IMAGE_ROOT):
            ...
            if os.path.isfile(filepath) and ".png" in filepath:
                 ...
                 image, result_text, scores = paddle_ocr(train_img, filepath)
